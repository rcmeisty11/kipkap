...
async def list_assessments(
    ...
    if not settings.illuminate_api_key:
        raise HTTPException(400, "Illuminate API key not configured")
    svc = IlluminateService(settings.illuminate_api_key, settings.illuminate_base_url)
    try:
